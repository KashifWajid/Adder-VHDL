...
HD_PWD=/home/qureshkd/Documents/Vivado_Tutorial/Adder/Adder.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log CarryLookAheadAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source CarryLookAheadAdder.tcl -notrace
